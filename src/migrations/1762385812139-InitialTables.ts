...
export class InitialTables1762385812139 implements MigrationInterface {
    name = 'InitialTables1762385812139'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE ""user"" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying NOT NULL, "passwordHash" character varying NOT NULL, "name" character varying, "tenantId" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_9bcf158e551defe1c0fb3cbe4a8" PRIMARY KEY ("id"))`);
